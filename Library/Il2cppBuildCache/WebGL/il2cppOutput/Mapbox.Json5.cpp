...
IL_012e:
	...
	}
	{
		...
		int64_t L_45 = (int64_t)(L_42)->GetAtUnchecked(static_cast<il2cpp_array_size_t>(L_44));
		uint64_t L_46;
...
IL_01cf:
	...
	}
	{
		...
		int64_t L_76 = (int64_t)(L_73)->GetAtUnchecked(static_cast<il2cpp_array_size_t>(L_75));
		uint64_t L_77;
...
IL_007e:
	...
	}
	{
		...
		L_29 = VirtFuncInvoker0< TypeU5BU5D_t85B10489E46F06CEC7C4B1CCBD0E01FAB6649755* >::Invoke(103 /* System.Type[] System.Type::GetGenericArguments() */, L_28);
		int32_t L_30 = 0;
		...
		L_33 = VirtFuncInvoker0< TypeU5BU5D_t85B10489E46F06CEC7C4B1CCBD0E01FAB6649755* >::Invoke(103 /* System.Type[] System.Type::GetGenericArguments() */, L_32);
		int32_t L_34 = 1;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void JPropertyList_CopyTo_m91B361C6802828F1BD7C2DE88DC690E394A1C611 (JPropertyList_t516667F5C08FE49C29B5F7E3B0B3FD355E36DB78 * __this, JTokenU5BU5D_t1719B285767938769159618B57356CD420595D0E* ___array0, int32_t ___arrayIndex1, const RuntimeMethod* method)
{
	...
	}
	{
		...
		(L_2)->SetAtUnchecked(static_cast<il2cpp_array_size_t>(L_3), (JToken_t2AD085E3E30B36EDB23247286E5C75F881A2C08E *)L_4);
	}
